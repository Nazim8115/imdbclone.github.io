...
(function () {
  ...
  async function fetchMovies(search) {
    const url = `https://www.omdbapi.com/?t=${search}&apikey=e34ccfe1`;
    try {
      ...
      movieCard.innerHTML = `
        ...
        <a href="movie_details.html" >
          ...
          <div class="card-body text-start">
            <h5 class="card-title" >
              <a href="movie_details.html" data-id = "${data.Title} "> ${data.Title}  </a>
            </h5>
  ...
  function addToFavDOM() {
    ...
    <div class="movie-card-details">
      <p class="movie-name mt-3 mb-0">
       <a href = "movie_details.html" class="fav-movie-name" data-id="${movie.Title}">${movie.Title}<a> 
      </p>
